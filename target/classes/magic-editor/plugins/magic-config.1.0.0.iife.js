...
__vite_style__.innerHTML = "\n.magic-config-info[data-v-00efb8f2]{\n  display: flex;\n  flex-direction: column;\n  flex: 1;\n  padding: 5px;\n}\n.magic-config-info form[data-v-00efb8f2]{\n  display: flex;\n}\n.magic-config-info form label[data-v-00efb8f2]{\n  display: inline-block;\n  width: 75px;\n  height: 22px;\n  line-height: 22px;\n  font-weight: 400;\n  text-align: right;\n  padding: 0 5px;\n}\n.magic-config-info form[data-v-00efb8f2] .magic-checkbox{\n  width: 22px;\n  height: 22px;\n}\n.magic-config-info form[data-v-00efb8f2] .magic-textarea{\n  margin: 5px;\n}\n";
...
var MagicConfig = function(vue) {
  ...
  var MagicConfigInfo = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-00efb8f2"]]);
  ...
  if (typeof window !== "undefined") {
    let loadSvg = function() {
      ...
      var svgDom = document.getElementById("__svg__icons__dom__1653235808153__");
      if (!svgDom) {
        svgDom = document.createElementNS("http://www.w3.org/2000/svg", "svg");
        svgDom.style.position = "absolute";
        svgDom.style.width = "0";
        svgDom.style.height = "0";
        svgDom.id = "__svg__icons__dom__1653235808153__";
